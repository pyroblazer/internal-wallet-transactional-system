Here’s an enhanced version of your API documentation, adding more detailed descriptions and explanations where appropriate.
...
2. Add the configuration for your local database settings:
   ...
   postgresql:
     ...
     development:
       url: postgres://username:password@localhost:5432/db_dev?schema=public
     test:
       url: postgres://username:password@localhost:5432/db_test?schema=public
     production:
       primary:
